  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 py-4 md:py-6 ">
      <motion.nav
        ...
        className={`flex items-center justify-between w-full max-w-7xl rounded-full px-4 md:px-8 py-2 border-2 border-t-[3px] border-x-[3px] border-white/10 transition-all duration-300  ${
